...
def main(argv):
  ...
  train_file = os.path.join(flags.data_dir, 'Interview.csv')
  test_file = os.path.join(flags.data_dir, 'Interview.csv')
...
class WideDeepArgParser(argparse.ArgumentParser):
  ...
  def __init__(self):
    ...
    self.add_argument(
        ...
        metavar='<MT>')
    self.set_defaults(
        data_dir='Users/Smith/AppData/Local/Programs/Python/Python36/Python testing/',
        model_dir='Users/Smith/AppData/Local/Programs/Python/Python36/Python testing/',
        train_epochs=40,
